...
import frc.robot.Constants.SwerveConstants.Mode;
...
public class Drive extends SubsystemBase {
  ...
  private static final double ROBOT_MOI = 5.859;
  ...
  public void periodic() {
    ...
    gyroDisconnectedAlert.set(
        !gyroInputs.connected && Constants.SwerveConstants.currentMode != Mode.SIM);
  }
