...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {    
    ...
    private double getChassisSpeedMagnitude() {
    ...
    public void periodic() {
        ...
        double angularVelocity = getState().Speeds.omegaRadiansPerSecond;
        ...
        // --- Light Vision Fusion ---
        vision.getEstimatedGlobalPose().ifPresent(pose -> {

        if (getChassisSpeedMagnitude() < 2.0 && angularVelocity < 2) {
